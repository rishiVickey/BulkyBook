    ...
    public class RegisterModel : PageModel
    {
        ...
        public async Task OnGetAsync(string returnUrl = null)
        {
            ...
            Input = new InputModel()
            {
                ...
                RoleList = _roleManager.Roles.Where(u => u.Name != SD.Role_User_Indi).Select(u => u.Name).Select(i => new SelectListItem
                {
                    Text = i,
                    Value = i
                })
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    if(!await _roleManager.RoleExistsAsync(SD.Role_Emp))
                    {
                        await _roleManager.CreateAsync(new IdentityRole(SD.Role_Emp));
                    }
                    ...
                    //Assigning role when registered
                    if (Input.Role == null)
                    {
                    ...
                    {
                        if(Input.Role == SD.Role_User_Indi && Input.Role==SD.Role_User_Comp)
                        {
